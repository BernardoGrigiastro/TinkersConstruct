...
public class BakedToolModel extends BakedWrapper.Perspective {
     ...
     */
    public BakedToolModel(IBakedModel parent, BakedMaterialModel[] parts, BakedMaterialModel[] brokenParts, Map<String, IBakedModel> modifierParts, ImmutableMap<TransformType, TRSRTransformation> transform, ImmutableList<BakedToolModelOverride> overrides) {
    ...
    protected static class ToolItemOverrideList extends ItemOverrideList {
        ...
        @Nonnull
        @Override
        public IBakedModel handleItemState(@Nonnull
                IBakedModel originalModel, final ItemStack stack, final World world, final EntityLivingBase entity) {
        ...
        private BakedToolModel getBaseModel(
                @Nonnull BakedToolModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
