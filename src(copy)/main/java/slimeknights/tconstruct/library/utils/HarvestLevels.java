...
public class HarvestLevels {
    ...
    public static void init() {
        ...
        harvestLevelNames.put(DIAMOND, TextFormat.AQUA + Util.translate("ui.mininglevel.diamond"));
        ...
        int i = 0;
        while (I18n.hasTranslation(String.format("%s%d", base, i))) {
            harvestLevelNames.put(i, I18n.translate(String.format("%s%d", base, i)));
            i++;
        }
