...
public abstract class BowCore extends ProjectileLauncherCore implements IAmmoUser, ILauncher {
    ...
    public void shootProjectile(
            @Nonnull ItemStack ammoIn, @Nonnull ItemStack bow, World worldIn, EntityPlayer player, int useTime) {
    ...
    @Override
    public void modifyProjectileAttributes(Multimap<String, EntityAttributeModifier> projectileAttributes,
