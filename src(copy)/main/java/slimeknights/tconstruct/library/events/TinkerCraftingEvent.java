...
public class TinkerCraftingEvent extends TinkerEvent {
    ...
    public static class ToolCraftingEvent extends TinkerCraftingEvent {
        ...
        public static void fireEvent(ItemStack itemStack, EntityPlayer player, DefaultedList<ItemStack> toolParts)
    ...
    public static class ToolModifyEvent extends TinkerCraftingEvent {
        ...
        public static void fireEvent(ItemStack itemStack, EntityPlayer player, ItemStack toolBeforeModification)
                throws TinkerGuiException {
