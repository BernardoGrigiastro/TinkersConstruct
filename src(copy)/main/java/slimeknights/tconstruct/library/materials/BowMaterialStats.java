...
public class BowMaterialStats extends AbstractMaterialStats {
    ...
    public List<String> getLocalizedInfo() {
        return ImmutableList.of(
                ...
                formatDrawspeed(1f / drawspeed), formatRange(range), formatDamage(bonusDamage));
    }

    @Override
    public List<String> getLocalizedDesc() {
        return ImmutableList.of(Util.translate(LOC_DrawspeedDesc), Util.translate(LOC_RangeDesc), Util.translate(LOC_DamageDesc));
    }
}
