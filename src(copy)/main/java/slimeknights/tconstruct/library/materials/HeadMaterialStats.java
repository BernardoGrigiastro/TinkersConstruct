...
public class HeadMaterialStats extends AbstractMaterialStats {
    ...
    @Deprecated public final static String TYPE = MaterialTypes.HEAD;
    ...
    public static String formatDurability(int durability, int ref) {
        return String.format("%s: %s", Util.translate(LOC_Durability), CustomFontColor.formatPartialAmount(durability, ref)) + TextFormat.RESET;
    }
