...
public class BlockSearedGlass extends BlockEnumSmeltery<BlockSearedGlass.GlassType> {
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess world, BlockPos position) {
        ...
        // connectable or not.
        return state.withProperty(BlockConnectedTexture.CONNECTED_DOWN, this.isSideConnectable(state, world, position, EnumFacing.DOWN)).withProperty(BlockConnectedTexture.CONNECTED_EAST, this.isSideConnectable(state, world, position, EnumFacing.EAST)).withProperty(BlockConnectedTexture.CONNECTED_NORTH, this.isSideConnectable(state, world, position, EnumFacing.NORTH)).withProperty(BlockConnectedTexture.CONNECTED_SOUTH, this.isSideConnectable(state, world, position, EnumFacing.SOUTH)).withProperty(BlockConnectedTexture.CONNECTED_UP, this.isSideConnectable(state, world, position, EnumFacing.UP)).withProperty(BlockConnectedTexture.CONNECTED_WEST, this.isSideConnectable(state, world, position, EnumFacing.WEST));
    }
