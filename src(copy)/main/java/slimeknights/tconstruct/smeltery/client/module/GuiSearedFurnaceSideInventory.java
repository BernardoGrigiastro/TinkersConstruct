...
public class GuiSearedFurnaceSideInventory extends GuiSideInventory {
    ...
    public static final Identifier SLOT_LOCATION = GuiSearedFurnace.BACKGROUND;
    ...
    public void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        for (Slot slot : inventorySlots.inventorySlots) {
            if (slot.getHasStack() && shouldDrawSlot(slot)) {
                ...
                if (tooltip != null && x + guiLeft <= mouseX && x + guiLeft + bar.w > mouseX && y + guiTop <= mouseY && y + guiTop + bar.h > mouseY) {
                    tooltipText = tooltip;
                }
