...
public class GuiSearedFurnace extends GuiHeatingStructureFuelTank {
    ...
    public GuiSearedFurnace(ContainerSearedFurnace container, TileSearedFurnace tile) {
        ...
        sideinventory = new GuiSearedFurnaceSideInventory(this, container.getSubContainer(ContainerSideInventory.class), furnace, furnace.getSizeInventory(), container.calcColumns());
