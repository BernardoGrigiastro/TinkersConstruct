...
public class GuiSmeltery extends GuiHeatingStructureFuelTank implements IGuiLiquidTank {
    ...
    public GuiSmeltery(ContainerSmeltery container, TileSmeltery smeltery) {
        ...
        sideinventory = new GuiSmelterySideInventory(this, container.getSubContainer(ContainerSideInventory.class), smeltery, smeltery.getSizeInventory(), container.calcColumns());
