...
public class SmelteryClientProxy extends ClientProxy {
    ...
    public void registerModels() {
        ...
        for (BlockSmelteryIO.IOType type : BlockSmelteryIO.IOType.values()) {
            String variant = String.format("%s=%s,%s=%s", BlockSmelteryIO.FACING.getName(), BlockSmelteryIO.FACING.getName(EnumFacing.SOUTH), BlockSmelteryIO.TYPE.getName(), BlockSmelteryIO.TYPE.getName(type));
        ...
        if (Config.claycasts) {
            ...
            CustomTextureCreator.castModelLocation = new Identifier(clayCastLoc.getResourceDomain(), "item/" + clayCastLoc.getResourcePath());
    ...
    public void init() {
        ...
        colors.registerItemColorHandler((@Nonnull ItemStack stack, int tintIndex) -> {
