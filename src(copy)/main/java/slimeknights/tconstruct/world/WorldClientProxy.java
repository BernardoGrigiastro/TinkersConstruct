...
public class WorldClientProxy extends ClientProxy {
    ...
    public void init() {
        ...
        blockColors.registerBlockColorHandler((state, access, pos, tintIndex) -> getSlimeColorByPos(pos, FoliageType.BLUE, SlimeColorizer.LOOP_OFFSET), TinkerWorld.slimeVineBlue1, TinkerWorld.slimeVineBlue2, TinkerWorld.slimeVineBlue3);
        blockColors.registerBlockColorHandler((state, access, pos, tintIndex) -> getSlimeColorByPos(pos, FoliageType.PURPLE, SlimeColorizer.LOOP_OFFSET), TinkerWorld.slimeVinePurple1, TinkerWorld.slimeVinePurple2, TinkerWorld.slimeVinePurple3);
        ...
        }, TinkerWorld.slimeGrass, TinkerWorld.slimeGrassTall, TinkerWorld.slimeLeaves, TinkerWorld.slimeVineBlue1, TinkerWorld.slimeVineBlue2, TinkerWorld.slimeVineBlue3, TinkerWorld.slimeVinePurple1, TinkerWorld.slimeVinePurple2, TinkerWorld.slimeVinePurple3);
    ...
    public void registerModels() {
        ...
        ModelLoader.setCustomStateMapper(TinkerWorld.slimeLeaves, (new StateMap.Builder()).ignore(BlockSlimeGrass.FOLIAGE, BlockLeaves.CHECK_DECAY, BlockLeaves.DECAYABLE).build());
        ...
        for (BlockSlimeGrass.FoliageType type : BlockSlimeGrass.FoliageType.values()) {
            for (BlockSlimeGrass.DirtType dirt : BlockSlimeGrass.DirtType.values()) {
                String variant = String.format("%s=%s,%s=%s", BlockSlimeGrass.SNOWY.getName(), BlockSlimeGrass.SNOWY.getName(false), BlockSlimeGrass.TYPE.getName(), BlockSlimeGrass.TYPE.getName(dirt));
                int meta = TinkerWorld.slimeGrass.getMetaFromState(TinkerWorld.slimeGrass.getDefaultState().withProperty(BlockSlimeGrass.TYPE, dirt).withProperty(BlockSlimeGrass.FOLIAGE, type));
