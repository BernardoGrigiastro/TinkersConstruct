...
public class SlimeColorizer implements IResourceManagerReloadListener {
    ...
    private static final Identifier LOC_SLIME_PURPLE_PNG = Util.getResource("textures/colormap/purplegrasscolor.png");
    private static final Identifier LOC_SLIME_ORANGE_PNG = Util.getResource("textures/colormap/orangegrasscolor.png");
