...
public class CompareVanilla extends CommandBase {
    ...
    public void execute(@Nonnull MinecraftServer server, @Nonnull ICommandSender sender, @Nonnull String[] args)
        ...
        testTools(Blocks.COBBLESTONE, wood, stone, iron, extra, new ItemStack(Items.WOODEN_PICKAXE), new ItemStack(Items.STONE_PICKAXE), new ItemStack(Items.IRON_PICKAXE), new ItemStack(Items.DIAMOND_PICKAXE), new ItemStack(Items.GOLDEN_PICKAXE));
        ...
        testTools(Blocks.DIRT, wood, stone, iron, extra, new ItemStack(Items.WOODEN_SHOVEL), new ItemStack(Items.STONE_SHOVEL), new ItemStack(Items.IRON_SHOVEL), new ItemStack(Items.DIAMOND_SHOVEL), new ItemStack(Items.GOLDEN_SHOVEL));
        ...
        testTools(Blocks.LOG, wood, stone, iron, extra, new ItemStack(Items.WOODEN_AXE), new ItemStack(Items.STONE_AXE), new ItemStack(Items.IRON_AXE), new ItemStack(Items.DIAMOND_AXE), new ItemStack(Items.GOLDEN_AXE));
        ...
        testTools(Blocks.MELON_BLOCK, wood, stone, iron, extra, new ItemStack(Items.WOODEN_SWORD), new ItemStack(Items.STONE_SWORD), new ItemStack(Items.IRON_SWORD), new ItemStack(Items.DIAMOND_SWORD), new ItemStack(Items.GOLDEN_SWORD));
    }
    ...
    protected String testTool(Block block, ItemStack tinker, ItemStack vanilla) {
        return testToolDurability(tinker, vanilla) + testToolSpeed(block, tinker, vanilla) + testToolAttack(tinker, vanilla);
    }
