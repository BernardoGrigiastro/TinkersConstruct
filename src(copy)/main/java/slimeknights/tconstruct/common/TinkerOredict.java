...
public class TinkerOredict {
    ...
    public static final Set<Item> COOKED_MEAT = ImmutableSet.<Item>builder().add(Items.COOKED_BEEF).add(Items.COOKED_CHICKEN).add(Items.COOKED_FISH).add(Items.COOKED_MUTTON).add(Items.COOKED_PORKCHOP).add(Items.COOKED_RABBIT).build();
