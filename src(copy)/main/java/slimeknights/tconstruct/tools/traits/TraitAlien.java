...
public class TraitAlien extends TraitProgressiveStats {
    ...
    public List<String> getExtraInfo(ItemStack tool, NBTTagCompound modifierTag) {
        ...
        return ImmutableList.of(HeadMaterialStats.formatDurability(pool.durability), HeadMaterialStats.formatMiningSpeed(pool.speed), HeadMaterialStats.formatAttack(pool.attack));
    }
