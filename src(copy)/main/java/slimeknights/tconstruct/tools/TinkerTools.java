...
public class TinkerTools extends AbstractToolPulse {
    ...
    @SidedProxy(clientSide = "slimeknights.tconstruct.tools.ToolClientProxy",
    ...
    private static void registerToolForgeRecipe(IForgeRegistry<Recipe> registry, String oredict) {
        ...
        // create the recipe
        TableRecipe recipe = new TableRecipe(Util.getResource("tool_forge"), new OreIngredient(oredict), new ItemStack(toolForge), CraftingHelper.parseShaped("BBB", "MTM", "M M", 'B', brick, 'M', oredict, 'T', new ItemStack(TinkerTools.toolTables, 1, TableTypes.ToolStation.meta)));
