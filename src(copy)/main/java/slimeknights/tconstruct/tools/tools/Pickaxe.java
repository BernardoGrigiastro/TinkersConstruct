...
public class Pickaxe extends AoeToolCore {
    ...
    public static final ImmutableSet<net.minecraft.block.Material> effective_materials = ImmutableSet.of(net.minecraft.block.Material.METAL, net.minecraft.block.Material.ANVIL, net.minecraft.block.Material.STONE, net.minecraft.block.Material.ICE, net.minecraft.block.Material.GLASS, net.minecraft.block.Material.PACKED_ICE, net.minecraft.block.Material.PISTON);
