...
public class Mattock extends AoeToolCore {
    ...
    public static final ImmutableSet<net.minecraft.block.Material> effective_materials_axe = ImmutableSet.of(net.minecraft.block.Material.WOOD, net.minecraft.block.Material.CACTUS, net.minecraft.block.Material.PLANT, net.minecraft.block.Material.REPLACEABLE_PLANT, net.minecraft.block.Material.PUMPKIN);

    public static final ImmutableSet<net.minecraft.block.Material> effective_materials_shovel = ImmutableSet.of(net.minecraft.block.Material.ORGANIC, net.minecraft.block.Material.EARTH, net.minecraft.block.Material.CLAY);
