...
public class Shovel extends AoeToolCore {
    ...
    public static final ImmutableSet<net.minecraft.block.Material> effective_materials = ImmutableSet.of(net.minecraft.block.Material.ORGANIC, net.minecraft.block.Material.EARTH, net.minecraft.block.Material.SAND, net.minecraft.block.Material.SNOW_BLOCK, net.minecraft.block.Material.SNOW, net.minecraft.block.Material.CLAY, net.minecraft.block.Material.CAKE);
