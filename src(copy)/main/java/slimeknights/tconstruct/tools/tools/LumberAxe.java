...
public class LumberAxe extends AoeToolCore {
    ...
    public static final ImmutableSet<net.minecraft.block.Material> effective_materials = ImmutableSet.of(net.minecraft.block.Material.WOOD, net.minecraft.block.Material.PUMPKIN, net.minecraft.block.Material.CACTUS);
