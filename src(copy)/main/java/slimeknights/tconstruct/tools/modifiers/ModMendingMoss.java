...
public class ModMendingMoss extends ModifierTrait {
    ...
    public void onUpdate(ItemStack tool, World world, Entity entity, int itemSlot, boolean isSelected) {
        ...
        if (!world.isClient && entity instanceof EntityLivingBase) {
            ...
            if (entity instanceof EntityPlayer && !InventoryPlayer.isHotbar(itemSlot) && ((EntityPlayer) entity).getHeldItemOffhand() != tool) {
                return;
            }
    ...
    public void onPickupXp(PlayerPickupXpEvent event) {
        ...
        List<ItemStack> tools = Lists.newArrayList(event.getEntityPlayer().getHeldItemMainhand(), event.getEntityPlayer().getHeldItemOffhand());
    ...
    public List<String> getExtraInfo(ItemStack tool, NBTTagCompound modifierTag) {
        ...
        return ImmutableList.of(Util.translateFormatted(loc, data.storedXp));
    }
