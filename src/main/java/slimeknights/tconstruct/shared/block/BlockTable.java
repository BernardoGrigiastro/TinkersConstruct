...
public class BlockTable extends BlockInventory implements BlockEntityProvider {
  ...
  private static ImmutableList<BoundingBox> BOUNDS_Table = ImmutableList.of(
      new BoundingBox(0, 0.75, 0, 1, 1, 1),
      new BoundingBox(0, 0, 0, 0.25, 0.75, 0.25),
      new BoundingBox(0.75, 0, 0, 1, 0.75, 0.25),
      new BoundingBox(0.75, 0, 0.75, 1, 0.75, 1),
      new BoundingBox(0, 0, 0.75, 0.25, 0.75, 1)
  );
