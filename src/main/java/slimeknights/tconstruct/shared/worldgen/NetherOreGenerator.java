...
public class NetherOreGenerator implements IWorldGenerator {
    ...
    public NetherOreGenerator() {
        cobaltGen = new WorldGenMinable(TinkerCommons.blockOre.getStateFromMeta(BlockOre.OreTypes.COBALT.getMeta()), 5, BlockMatcher.forBlock(Blocks.NETHERRACK));
        
        arditeGen = new WorldGenMinable(TinkerCommons.blockOre.getStateFromMeta(BlockOre.OreTypes.ARDITE.getMeta()), 5, BlockMatcher.forBlock(Blocks.NETHERRACK));
    }
