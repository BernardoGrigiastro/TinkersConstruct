...
public class TinkerCommons extends TinkerPulse {
    ...
    @SidedProxy(clientSide = "slimeknights.tconstruct.shared.CommonsClientProxy",
    ...
    public void registerRecipes(Register<Recipe> event) {
        ...
        Ingredient[] ignore = new Ingredient[]{Config.matchVanillaSlimeblock ? new OreIngredient("slimeballGreen") : Ingredient.fromStacks(matSlimeBallPink.copy()), new OreIngredient("slimeballBlue"), new OreIngredient("slimeballPurple"), new OreIngredient("slimeballBlood"), new OreIngredient("slimeballMagma")};
