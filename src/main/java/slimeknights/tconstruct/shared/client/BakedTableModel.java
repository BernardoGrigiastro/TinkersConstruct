...
public class BakedTableModel extends BakedModelWrapper<IBakedModel> {
    ...
    private final LoadingCache<PropertyTableItem.TableItem, IBakedModel> tableItemCache = CacheBuilder.newBuilder().maximumSize(250).build(new CacheLoader<PropertyTableItem.TableItem, IBakedModel>() {
        @Override
    ...
    private static class TableItemOverrideList extends ItemOverrideList {
        ...
        public IBakedModel handleItemState(
                @Nonnull IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
