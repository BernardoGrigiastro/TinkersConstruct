...
public abstract class SlimeFluid extends ForgeFlowingFluid {
    ...
    public static class Flowing extends SlimeFluid {
        ...
        public Flowing(Properties properties) {
            super(properties);
            this.setDefaultState(this.getStateContainer().getBaseState().with(LEVEL, 7));
        }
        
        @Override
        protected void fillStateContainer(StateFactory.Builder<Fluid, FluidState> builder) {
