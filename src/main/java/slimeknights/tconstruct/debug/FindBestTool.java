...
public class FindBestTool extends CommandBase {
    ...
    public void execute(@Nonnull MinecraftServer server, @Nonnull ICommandSender sender, @Nonnull String[] args)
        ...
        Function<ItemStack, ?> functions[] = new Function[]{new Function<ItemStack, Integer>() {
            @Override
        ...
        do {
            ...
            filter[0] = new Predicate<Triple<ItemStack, ImmutableList<Material>, Object[]>>() {
                ...
                public boolean apply(@Nullable Triple<ItemStack, ImmutableList<Material>, Object[]> entry) {
                    return ((Integer) entry.getRight()[0]) > durPercentile2 && ((Float) entry.getRight()[1]) > speedPercentile2;
                }
            };
            ...
            filter[1] = new Predicate<Triple<ItemStack, ImmutableList<Material>, Object[]>>() {
                ...
                @Override
                public boolean apply(@Nullable Triple<ItemStack, ImmutableList<Material>, Object[]> entry) {
                    return ((Integer) entry.getRight()[0]) > durPercentile2 && ((Float) entry.getRight()[2]) > attackPercentile2;
                }
            };
            ...
            filter[2] = new Predicate<Triple<ItemStack, ImmutableList<Material>, Object[]>>() {
                ...
                @Override
                public boolean apply(@Nullable Triple<ItemStack, ImmutableList<Material>, Object[]> entry) {
                    return ((Integer) entry.getRight()[0]) > durPercentile2 && ((Float) entry.getRight()[1]) > speedPercentile2 && ((Float) entry.getRight()[2]) > attackPercentile2;
                }
            };
        ...
        Collection<Triple<ItemStack, ImmutableList<Material>, Object[]>> sortedDurability = new Ordering<Triple<ItemStack, ImmutableList<Material>, Object[]>>() {
            ...
            @Override
            public int compare(
                    @Nullable Triple<ItemStack, ImmutableList<Material>, Object[]> left,
                    @Nullable Triple<ItemStack, ImmutableList<Material>, Object[]> right) {
