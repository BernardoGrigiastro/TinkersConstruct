...
public final class CommonItems {
    ...
    private static void registerBrick(BaseRegistryAdapter<Item> registry, String name) {
        registry.register(new Item(new Item.Settings().group(TinkerRegistry.tabGeneral)), name + "_brick");
    }
    
    private static void registerIngotNugget(BaseRegistryAdapter<Item> registry, String name) {
        registry.register(new Item(new Item.Settings().group(TinkerRegistry.tabGeneral)), name + "_nugget");
        registry.register(new Item(new Item.Settings().group(TinkerRegistry.tabGeneral)), name + "_ingot");
    }
}
