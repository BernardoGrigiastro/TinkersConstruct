...
public class TinkerGadgets extends TinkerPulse {
    ...
    @SidedProxy(clientSide = "slimeknights.tconstruct.gadgets.GadgetClientProxy",
    ...
    private void registerSmelting() {
        ...
        for (SlimeType type : SlimeType.values()) {
            GameRegistry.addSmelting(new ItemStack(TinkerCommons.blockSlimeCongealed, 1, type.getMeta()), new ItemStack(slimeChannel, 3, type.getMeta()), 0.15f);
        }
