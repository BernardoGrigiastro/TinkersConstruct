...
public class Exploder {
    ...
    void handleEntities() {
        final Predicate<Entity> predicate = entity -> entity != null && !entity.isImmuneToExplosions() && EntitySelectors.NOT_SPECTATING.apply(entity) && EntitySelectors.IS_ALIVE.apply(entity) && entity.getPositionVector().squareDistanceTo(x, y, z) <= r * r;
        
        // damage and blast back entities
        List<Entity> list = world.getEntitiesInAABBexcluding(this.exploder, new BoundingBox(x - r - 1, y - r - 1, z - r - 1, x + r + 1, y + r + 1, z + r + 1), predicate);
