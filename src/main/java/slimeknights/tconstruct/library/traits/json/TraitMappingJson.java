...
public class TraitMappingJson {
    ...
    @SerializedName("default") private final List<Identifier> defaultTraits;
    ...
    public Map<MaterialStatsId, List<TraitId>> getPerStat() {
        ...
        return perStat.entrySet().stream().collect(Collectors.toMap(entry -> new MaterialStatsId(entry.getKey()), entry -> transformTraitIds(entry.getValue())));
    }
