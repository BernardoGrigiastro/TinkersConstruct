...
public class BakedSimpleItem implements IBakedModel {
    ...
    private BakedSimpleItem(ImmutableList<BakedQuad> quads, Sprite particle, ImmutableMap<ItemCameraTransforms.TransformType, TRSRTransformation> transforms, ItemOverrideList overrides,
            @Nullable IBakedModel unculledModel) {
        this.quads = quads;
