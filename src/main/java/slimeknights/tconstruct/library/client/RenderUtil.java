...
public final class RenderUtil {
        ...
        for (int y = 0; y <= yd; y++) {
            for (int z = 0; z <= zd; z++) {
                for (int x = 0; x <= xd; x++) {
                    ...
                    if (x == 0)
                        putTexturedQuad(renderer, flowing, x1, y1, z1, x2, y2, z2, EnumFacing.WEST, color, brightness, true, upsideDown);
                    if (x == xd)
                        putTexturedQuad(renderer, flowing, x1, y1, z1, x2, y2, z2, EnumFacing.EAST, color, brightness, true, upsideDown);
                    if (y == 0)
                        putTexturedQuad(renderer, still, x1, y1, z1, x2, y2, z2, EnumFacing.DOWN, color, brightness, false, upsideDown);
                    if (y == yd)
                        putTexturedQuad(renderer, still, x1, y1, z1, x2, y2, z2, EnumFacing.UP, color, brightness, false, upsideDown);
                    if (z == 0)
                        putTexturedQuad(renderer, flowing, x1, y1, z1, x2, y2, z2, EnumFacing.NORTH, color, brightness, true, upsideDown);
                    if (z == zd)
                        putTexturedQuad(renderer, flowing, x1, y1, z1, x2, y2, z2, EnumFacing.SOUTH, color, brightness, true, upsideDown);
                }
            }
        }
    ...
    public static void putTexturedCuboid(BufferBuilder renderer, Identifier location, double x1, double y1, double z1, double x2, double y2, double z2, int color, int brightness) {
    ...
    public static void putTexturedQuad(BufferBuilder renderer, Sprite sprite, double x, double y, double z, double w, double h, double d, EnumFacing face, int color, int brightness, boolean flowing) {
        putTexturedQuad(renderer, sprite, x, y, z, w, h, d, face, color, brightness, flowing, false);
    }
    
    public static void putTexturedQuad(BufferBuilder renderer, Sprite sprite, double x, double y, double z, double w, double h, double d, EnumFacing face, int color, int brightness, boolean flowing, boolean flipHorizontally) {
    ...
    public static void putTexturedQuad(BufferBuilder renderer, Sprite sprite, double x, double y, double z, double w, double h, double d, EnumFacing face, int r, int g, int b, int a, int light1, int light2, boolean flowing) {
    ...
    public static void putTexturedQuad(BufferBuilder renderer, Sprite sprite, double x, double y, double z, double w, double h, double d, EnumFacing face, int r, int g, int b, int a, int light1, int light2, boolean flowing, boolean flipHorizontally) {
        // safety
        if (sprite == null) {
            return;
        }
     ...
     */
    public static void putRotatedQuad(BufferBuilder renderer, Sprite sprite, double x, double y, double z, double w, double d, EnumFacing rotation, int color, int brightness, boolean flowing) {
        int l1 = brightness >> 0x10 & 0xFFFF;
        int l2 = brightness & 0xFFFF;
     ...
     * Similar to putTexturedQuad, except its only for upwards quads and a rotation is specified
     */
    public static void putRotatedQuad(BufferBuilder renderer, Sprite sprite, double x, double y, double z, double w, double d, EnumFacing rotation, int r, int g, int b, int a, int light1, int light2, boolean flowing) {
        // safety
        if (sprite == null) {
            return;
        }
