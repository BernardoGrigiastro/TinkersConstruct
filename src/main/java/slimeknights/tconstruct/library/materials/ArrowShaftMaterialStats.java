...
public class ArrowShaftMaterialStats extends AbstractMaterialStats {
    ...
    public List<String> getLocalizedInfo() {
        return ImmutableList.of(formatModifier(modifier), formatAmmo(bonusAmmo));
    }

    @Override
    public List<String> getLocalizedDesc() {
        return ImmutableList.of(Util.translate(LOC_MultiplierDesc), Util.translate(LOC_AmmoDesc));
    }
}
