...
public class HandleMaterialStats extends AbstractMaterialStats {
    ...
    @Deprecated public final static String TYPE = MaterialTypes.HANDLE;
    ...
    public List<String> getLocalizedInfo() {
        return ImmutableList.of(formatModifier(modifier), formatDurability(durability));
    }

    @Override
    public List<String> getLocalizedDesc() {
        return ImmutableList.of(Util.translate(LOC_MultiplierDesc), Util.translate(LOC_DurabilityDesc));
    }
}
