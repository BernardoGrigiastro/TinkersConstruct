...
public class FletchingMaterialStats extends AbstractMaterialStats {
    ...
    public List<String> getLocalizedInfo() {
        return ImmutableList.of(formatModifier(modifier), formatAccuracy(accuracy));
    }

    @Override
    public List<String> getLocalizedDesc() {
        return ImmutableList.of(Util.translate(LOC_MultiplierDesc), Util.translate(LOC_AccuracyDesc));
    }
}
