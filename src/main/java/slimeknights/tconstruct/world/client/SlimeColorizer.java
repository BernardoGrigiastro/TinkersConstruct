...
public class SlimeColorizer {
    ...
    private static final Identifier LOC_SLIME_BLUE_PNG = Util.getResource("textures/colormap/slime_grass_color.png");
    private static final Identifier LOC_SLIME_PURPLE_PNG = Util.getResource("textures/colormap/purple_grass_color.png");
    private static final Identifier LOC_SLIME_ORANGE_PNG = Util.getResource("textures/colormap/orange_grass_color.png");
