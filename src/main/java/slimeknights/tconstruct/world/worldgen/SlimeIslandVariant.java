...
public enum SlimeIslandVariant implements StringIdentifiable {
    ...
    MAGMA(3, WorldBlocks.orange_magma_slime_grass.getDefaultState(), Blocks.field_10164, createArray(WorldBlocks.congealed_magma_slime.getDefaultState(), WorldBlocks.congealed_blood_slime.getDefaultState()), null, createArray(WorldBlocks.orange_slime_fern.getDefaultState(), WorldBlocks.orange_slime_tall_grass.getDefaultState()));
    ...
    SlimeIslandVariant(int index, BlockState lakeBottom, Block lakeFluid, BlockState[] congealedSlime, BlockState vine, BlockState[] tallGrass) {
        ...
        if (lakeFluid != null) {
            ...
            this.lakeFluid = Blocks.field_10382.getDefaultState();
        }
